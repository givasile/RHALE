...
class PDPwithICE:
    ...
    def plot(
        ...
        vis.plot_pdp_ice(x, feature, self.y_pdp, self.y_ice, normalize=normalized,
                         scale_x=scale_x, scale_y=scale_y, ylim=ylim, title=title,
                         ground_truth=ground_truth, savefig=savefig)
...
class PDPwithdICE:
    ...
    def plot(
        ...
        x = np.linspace(self.axis_limits[0, feature], self.axis_limits[1, feature], nof_points)
        title = "PDP-ICE: feature %d" % (feature + 1)
        vis.plot_pdp_ice(x, feature, self.y_pdp, self.y_ice, title=title, normalize=normalized, ylim=ylim,
